        ...
        {teacherData && (
          <div className="dashboard-container">
            <div className="profile-info">
              <div className="profile-container">
                ...
                <div className="profile-details">
                  ...
                  <p className="profile-info-text">{teacherData.degree}</p>
                  <p className="profile-info-text">{teacherData.specialization}</p>
            ...
            <div className="action-buttons">
              ...
              <Link to="/teacher_courses" className="action-div primary-bg">
                My Courses
              </Link>
              <Link to="/add_course" className="action-div primary-bg">
                Add Course
              </Link>
              <Link to="/mystudents" className="action-div primary-bg">
                My Students
              </Link>
              <Link to="/teacherstats " className="action-div primary-bg">
                My Stats
              </Link>
